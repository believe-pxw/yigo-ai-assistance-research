...
- 根定义：[DomainDef.xsd](file:///d:/Workbench/idea/yigo-ai-assistance-research/resource/xsd/xsd/DomainDef.xsd)
- 专有属性：[DomainDefDefine.xsd](file:///d:/Workbench/idea/yigo-ai-assistance-research/resource/xsd/xsd/element/complex/DomainDefDefine.xsd)

## 文件结构

```
resource/Domain/
├── DomainDef_TextEditor.xml
├── DomainDef_NumberEditor.xml
├── DomainDef_Dictionary.xml
├── DomainDef_DynamicDict.xml
├── DomainDef_ComboBox.xml
├── DomainDef_CheckBox.xml
├── DomainDef_CheckListBox.xml
├── DomainDef_DatePicker.xml
├── DomainDef_UTCDatePicker.xml
├── DomainDef_MonthPicker.xml
├── DomainDef_TimePicker.xml
├── DomainDef_Button.xml
├── DomainDef_TextButton.xml
├── DomainDef_Image.xml
├── DomainDef_PasswordEditor.xml
├── DomainDef_RichEditor.xml
├── DomainDef_TextArea.xml
├── DomainDef_Separator.xml
├── DomainDef_SystemField.xml
├── DomainDef_ERPSystemField.xml
└── DomainDef_WebBrowser.xml
```
...
```xml
<Domain Key="DY_Factory" Caption="工厂（动态）" RefControlType="DynamicDict" DataType="Long" ItemKey="Factory"/>
```

属性同 Dict。→ 追加到 `DomainDef_DynamicDict.xml`
